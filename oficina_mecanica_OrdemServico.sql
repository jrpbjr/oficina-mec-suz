...
CREATE TABLE `OrdemServico` (
  ...
  CONSTRAINT `OrdemServico_ibfk_1` FOREIGN KEY (`idVeiculo`) REFERENCES `Veiculo` (`idVeiculo`),
  CONSTRAINT `OrdemServico_ibfk_2` FOREIGN KEY (`idEquipe`) REFERENCES `Equipe` (`idEquipe`)
...
-- Dump completed on 2024-11-09 22:33:01
